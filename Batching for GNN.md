...
## Batching for GNN
- GIven I training graphs ${X_{i}, A_{i}}$ and labels $y_{i}$, params ${\Phi = \{\beta_{k}, \Omega_{k}}\}^{K}_{k=0}$ , [[./SGD|SGD]]and [[./Binary Cross Entropy|Binary Cross Entropy]]
