...
# ConvNeXt
- @liuConvNet2020s2022
- modifying a standard [Res Net](./Res%2520Net.md#) , following design choices closely inspired by [Vision Transformer](./Vision%2520Transformer.md#)
...
- hierarchical Transformers (e.g., [Swin Transformer](./Swin%2520Transformer.md#) ) that reintroduced several [Conv](./Conv.md#) priors, making Transformers practically viable as a generic vision backbone
...
- extending the number of epochs, using [AdamW](./AdamW.md#) optimizer, Stochastic Depth, [Label Smoothing](./Label%2520Smoothing.md#)
...
- [Depthwise Separable](./Depthwise%2520Separable.md#) , which are interestingly similar to self-[Attention](./Attention.md#) as they work on a per-channel basis
...
- [GELU](./GELU.md#) instead of [Relu](./Relu.md#) , a single activation for each block (the original [Transformer](./Transformer.md#.md#) module has just one activation after the MLP), fewer normalization [Layers](./Layers.md#), [Batch Normalization](./Batch%2520Normalization.md#) substituted by [Layer Normalization](./Layer%2520Normalization.md#) , and separate [Downsampling](./Downsampling.md#) layer
- [ImageNet](./ImageNet.md#)
- [COCO](./COCO.md#)
- [ADE20K](ADE20K.md)
- A case in point is multi-modal learning, in which a cross-[Attention](./Attention.md#.md#) module may be preferable for modeling feature interactions across many modalities
