...
- Sparse factorizations of the [Attention](./Attention.md#.md#) matrix
- Reduce to $O(n\sqrt{n})$
- Recompute [Attention](./Attention.md#.md#) matrices to save memory
- Fast [Attention](./Attention.md#.md#) kernels
