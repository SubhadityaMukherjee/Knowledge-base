...
- [Unsupervised Learning](./Unsupervised%2520Learning.md#) algorithm which captures both global statistics and local statistics of a corpus
...
- global log-bilinear [LinearRegression](./LinearRegression.md#) model for the [Unsupervised Learning](./Unsupervised%2520Learning.md#) of word representations
