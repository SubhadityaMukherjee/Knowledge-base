...
```
- Two classes
- Probability distribution - [Bernoulli Distribution](./Bernoulli%2520Distribution.md#)
- Training -> Model to predict $\lambda$, but these values might not lie in [0,1] and we need it to. -> [Sigmoid](./Sigmoid.md#)
- [Cross Entropy](./Cross%2520Entropy.md#)
- ![](./images/Pasted%20image%2020240828101513.webp)
...
- ![](./images/Pasted%20image%2020240828101723.webp)