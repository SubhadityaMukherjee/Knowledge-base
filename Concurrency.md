...
- Both the maximum and the average degrees of concurrency usually increase as the [Parallel Granularity](./Parallel%2520Granularity.md#) of tasks becomes smaller (finer)
