...
- Given a vector of [Logits](./Logits.md#) z as the outputs of the last fully connected layer of a deep model, the [Distillation Loss](./Distillation%2520Loss.md#) for response-based knowledge can be formulated as
