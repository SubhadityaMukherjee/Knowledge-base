...
- Look up past-tense
	...
	- [past tense](./past%2520tense.md#)
	- Irregular forms stored in associative memory ([Declarative memory](./Declarative%2520memory.md#))
	- Symbolic rules produce [past tense](./past%2520tense.md#) forms (procedural memory)
	...
	- Time 3: Child realizes that there are irregular and regular forms
		...
		- new and novel verbs will get regular endings in [past tense](./past%2520tense.md#) unless exposed to irregular past
...
- [Challenges of Words-and-rules](./Challenges%2520of%2520Words-and-rules.md#)
