...
- Assume true label to be y, then a truth [Probability](./Probability.md#.md#) distribution would be $p_i=1$ If i=y and 0 otherwise
- During training, minimize negative [Cross Entropy](./Cross%2520Entropy.md#) loss to make these [Distributions](Distributions.md) similar
