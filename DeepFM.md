...
- combines the power of factorization machines for recommendation and deep learning for [Feature Learning](./Feature%2520Learning.md#) in a new neural network architecture
- Criteo
