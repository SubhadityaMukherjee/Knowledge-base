...
- x-vectors are compared with i-vector baselines on [Speakers in the Wild](./Speakers%2520in%2520the%2520Wild.md#) and [NIST SRE 2016 Cantonese](./NIST%2520SRE%25202016%2520Cantonese.md#) where they achieve superior performance on the evaluation datasets
