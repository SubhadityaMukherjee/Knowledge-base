...
# Cosine Similarity
- [Lp Regularization](./Lp%2520Regularization.md#) l2norm aka p = 2
...
- If you take a [Recommender System](./Recommender%2520System.md#), for example, then the cosine similarity does not take into account the difference in rating scale between different users
