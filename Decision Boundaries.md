...
- $f_{i}$ be the [PDF](./PDF.md#) for [Class Conditional distribution](./Class%2520Conditional%2520distribution.md#)
- [Probability](./Probability.md#) of obtaining a correct classification for $R_{i}$ is $$\Sigma_{i=1}^{k}P(X \in R_{i}, Y = c_{i})$$
- ![](./images/Pasted%20image%2020220318161058.webp)
...
- Algo learns estimates of the [Class Conditional distribution](./Class%2520Conditional%2520distribution.md#.md#) and class probabilities aka priors
