...
- [Google’s Neural Machine Translation System: Bridging the Gap Between Human and Machine Translation](https://arxiv.org/abs/1609.08144)
	...
	- improve parallelism and therefore decrease training time, their [Attention](./Attention.md#.md#) mechanism connects the bottom layer of the decoder to the top layer of the encoder
	- low-precision arithmetic during inference computations ([FP16 training](./FP16%2520training.md#) ???)
	...
	- [Beam search](./Beam%2520search.md#) technique employs a length-normalization procedure and uses a coverage penalty
