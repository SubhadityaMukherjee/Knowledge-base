...
- unsupervised spoken unit discovery coupled with a dual-[Tower](./Tower.md#) [Transformer](./Transformer.md#) architecture with cross-[Attention](./Attention.md#) trained on 2000 hours of two-channel raw conversational audio [Fisher Spanish-English](./Fisher%2520Spanish-English.md#) without any text or labels
