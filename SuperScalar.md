...
# SuperScalar
- A superscalar CPU architecture implements [Instruction level programming](./Instruction%2520level%2520programming.md#) inside a single processor which allows faster CPU throughput at the same clock rate.
