...
```toc
```
- Using [Maximum Likelihood](./Maximum%2520Likelihood.md#)
- For training data ${x_{i}, y_{i}}$
	...
	- Training -> Find the parameters $\phi$ that minimize the [Negative Log Likelihood](./Negative%2520Log%2520Likelihood.md#) over the training data ${x_{i}, y_{i}}$ 
