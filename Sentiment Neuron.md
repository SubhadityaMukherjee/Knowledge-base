...
# Sentiment Neuron
- Linear model + L1 [Lp Regularization](./Lp%2520Regularization.md#)
- Uses very few learned units
- Single sentiment neuron that predicts the sentiment value
- ![](./images/Pasted%20image%2020220425233333.webp)
- Can be useful for [Unsupervised Learning](./Unsupervised%2520Learning.md#)
