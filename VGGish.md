...
- model using embeddings learned from the video-level task do much better than a baseline on the [AudioSet classification](./AudioSet%2520classification.md#) task
