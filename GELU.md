...
- $$x\Phi(x)$$ where $\Phi(x)$ is the [Normal Distribution](./Normal%2520Distribution.md#) [CDF](./CDF.md#)
...
- Used in [GPT3](./GPT3.md#), [Transformer](./Transformer.md#), [Vision Transformer](./Vision%2520Transformer.md#), [BERT](./BERT.md#)
