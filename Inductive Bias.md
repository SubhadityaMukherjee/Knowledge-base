...
- In [Bayesian](./Bayesian.md#)
	- [Bayesian Prior](./Bayesian%2520Prior.md#) can shape the [Bayesian Posterior](./Bayesian%2520Posterior.md#) in the way that it can be a similar distribution to the former
- In [KNN](KNN)
...
- [Non Relational Inductive Bias](./Non%2520Relational%2520Inductive%2520Bias.md#)
- [Relational Inductive Bias](./Relational%2520Inductive%2520Bias.md#)
