...
- Notice that there is a one-to-one relationship between the step, the [Learning Event](./Learning%2520Event.md#) and the [Knowledge Component](./Knowledge%2520Component.md#). This is a major contributor to the simplicity of Steve's analysis.
