...
- much different approach to meta-learning than [Neural Augmentation](Neural%20Augmentation.md)
- AutoAugment is a Reinforcement Learning algorithm that searches for an optimal augmentation policy amongst a constrained set of [Geometric Transformations](Geometric%20Transformations.md) with miscellaneous levels of distortions. For example, ‘translateX 20 pixels’ could be one of the transformations in the search space
