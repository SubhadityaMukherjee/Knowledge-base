...
- Use univariate [Normal Distribution](./Normal%2520Distribution.md#) 
	- ![](./images/Pasted%20image%2020240828095716.webp)
- ![](./images/Pasted%20image%2020240828095740.webp)
- ![](./images/Pasted%20image%2020240828095747.webp)
- Find parameters $\hat \phi$ that minimize $L[\phi]$\
- [Least squares loss](./Least%2520squares%2520loss.md#)

## Inference
- Predict the mean $\mu = f[x, \phi]$ of the [Normal Distribution](./Normal%2520Distribution.md#) over y
...
- ![](./images/Pasted%20image%2020240828100529.webp)
- ![](./images/Pasted%20image%2020240828100420.webp)
...
- ![](./images/Pasted%20image%2020240828100835.webp)

### [Homoscedatic](./Homoscedatic.md#) vs [Heteroscedatic](./Heteroscedatic.md#) Regression
- ![](./images/Pasted%20image%2020240828100938.webp)
