...
- two-stage model: a prior that generates a [CLIP](./CLIP.md#) image [Embedding](./Embedding.md#) given a text caption, and a “unCLIP” decoder that generates an image conditioned on the image [Embedding](./Embedding.md#.md#)
