...
- probabilistic [Contrastive Loss](./Contrastive%2520Loss.md#) based on NCE, which both the encoder and [Autoregressive](./Autoregressive.md#) model are trained to jointly optimize, which they call InfoNCE
