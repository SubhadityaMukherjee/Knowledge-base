...
- Collaborative [[./Filtering|Filtering]] (CF) is a successful approach commonly used by many recommender systems
...
- To address this [[./Sparsity|Sparsity]] problem, auxiliary information such as item content information may be utilized
...
- generalizing recent advances in deep learning from i.i.d input to non-i.i.d (CF-based) input and propose a hierarchical [[./Bayesian|Bayesian]] model called collaborative deep learning (CDL), which jointly performs deep representation learning for the content information and collaborative [[./Filtering|Filtering]] for the ratings (feedback) matrix.
