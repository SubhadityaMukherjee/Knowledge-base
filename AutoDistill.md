...
- [[./Bayesian|Bayesian]] Optimization to conduct multi-objective Neural Architecture Search for selecting student model architectures
- proposed search comprehensively considers both prediction accuracy and serving latency on target hardware
- TPUv4i
- MobileBERT
- [[./GLUE|GLUE]]
- higher than BERT_BASE, DistillBERT, [[./TinyBERT|TinyBERT]], NAS-BERT, and MobileBERT
