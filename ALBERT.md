...
# ALBERT
- Lite [[./BERT|BERT]]
- ![[./images/Pasted image 20220625231702.webp|Pasted image 20220625231702.webp]]
...
- perhaps even better when scaled to the same number of parameters as [[./BERT|BERT]]
...
- [[./SQuAD|SQuAD]]
- [[./RACE|RACE]]
- For [[./Factorized Embedding Parameters|Factorized Embedding Parameters]], the authors report good performance. Both the case where cross-layer parameters were not shared and where they were, are reported. Without sharing, larger [[./Embedding|Embedding]] sizes give better performance. With sharing, performance boosts satisfy at an [[./Embedding|Embedding]] size of 128 dimensions. That's why the 128-size embeddings were used in the table above.
- For [[./cross-layer parameter sharing|cross-layer parameter sharing]], the authors looked at not performing cross-layer sharing, performing cross-layer sharing for the feedforward segments only, performing sharing for the [[./Attention|Attention]] segments, and performing sharing for all subsegments. It turns out that sharing the parameters for the [[./Attention|Attention]] segments is most effective, while sharing the feedforward segment parameters does not contribute significantly. This clearly illustrates the important role of the [[./Attention|Attention]] mechanism in [[./Transformer|Transformer]] models. Because, however, all-segment sharing significantly decreases the number of parameters, at only slightly worse performance compared to [[./Attention|Attention]]-only sharing, the authors to perform all-segment sharing instead.
