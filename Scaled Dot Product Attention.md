...
# Scaled [Dot Product Attention](./Dot%2520Product%2520Attention.md#)
...
- Generalization of [Soft Attention](./Soft%2520Attention.md#)
- ![](../images/Pasted%20image%2020220526133045.png)
- [Attention Alignment](./Attention%2520Alignment.md#) score $$\alpha_{t,i} = \frac{s_{t}^{T}h_{i}}{\sqrt{n}}$$
