...
- ![](./images/Pasted%20image%2020220316121901.webp)
	...
	- High chances of class not being present in data
		...
		- Cannot use
- 20 dim [PMF](./PMF.md#.md#) for amnio acid distrib : $\theta = (\theta_{1}, … ,\theta_{20})' = (P(X=A), …, P(X=Y))'$
	- count vectors of amino acids found in a given site in training data D
	- Distributed according to [Multinomial Distribution](./Multinomial%2520Distribution.md#) with l = 20
...
- 0 probabilities should not occur. $$\mathcal{H} = (\theta_{1}, …, \theta_{20})' \in \mathbb{R}^{20}|\theta_{j} \in (0,1)$$ and $$ \Sigma_{j} \theta_{j}=1$$
	...
	- [Dirichlet Distribution](./Dirichlet%2520Distribution.md#) is used to represent it because parameterized with l = 20
- ![](./images/Pasted%20image%2020220316123546.webp)
