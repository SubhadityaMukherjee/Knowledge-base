...
- [CvT: Introducing Convolutions to Vision Transformers](https://arxiv.org/abs/2103.15808)
	- improves [Vision Transformer](./Vision%2520Transformer.md#)
	...
	- [Position Encoding](./Position%2520Encoding.md#) , a crucial component in existing Vision Transformers, can be safely removed in our model
