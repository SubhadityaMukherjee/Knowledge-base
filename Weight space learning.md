...
- [[./Autoencoders with Convolutions#Encoder|Encoder]] [[./Autoencoders with Convolutions#Decoder|Decoder]] [[./architecture|architecture]] for weight vectors
...
- rather huge model zoo generated
	...
	- magnitude [[./Pruning|Pruning]]
	- two types of pre-training : supervised, [[./Contrastive Loss|contrastive]]
- weight space is symmetric sometimes : ACG [[./architecture|architecture]]
...
- [[./Initialization#Initialization|initialization]]
	...
	- he normal
	- truncated normal
- train and test on [[./MNIST|MNIST]] ,[[./Fashion MNIST|Fashion MNIST]] , [[./CIFAR|CIFAR]] , [[./SVHN|SVHN]]
...
- train a encoder decoder transformer 
	...
	- took the weight vector and calculated MSE
		...
		- also what was apparently needed for [[./Stable Difusion|Stable Difusion]]
		- paper : [[Taming Transformers for high res image synthesis|Taming Transformers for high res image synthesis]]
			- perception loss + [[GAN|GAN]]
- sample space
