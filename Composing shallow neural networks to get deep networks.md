...
- Consider two networks with 3 hidden units. Input $x, x'$ , output $y, y'$
	- ![](./images/Pasted%20image%2020240827202511.webp)
	- ![](./images/Pasted%20image%2020240827202529.webp)
- ![](./images/Pasted%20image%2020240827201808.webp)
...
- ![](./images/Pasted%20image%2020240827203123.webp)
...
- ![](./images/Pasted%20image%2020240827203340.webp)
### Folding space
- One way to think about composing networks is by thinking of it as folding space and then applying an [Activation Functions](./Activation%2520Functions.md#). 
- ![](./images/Pasted%20image%2020240827202757.webp)
	- ![](./images/Pasted%20image%2020240827204450.webp)
