...
- Minimization problem $$(w,b) = argmin_{w^{\ast} , b^{\ast}} \Sigma^N_{i-1}(w^{\ast}x_{i} +b ^{\ast} - y_{i})^2$$
	- [Affine Function](./Affine%2520Function.md#)
...
- $$w' = (XX')^{-1}X y$$
	- If y is has vector data too (size k)
		- $$W' = (XX')^{-1}XY$$
		- Y : N x k matrix
- ![](./images/Pasted%20image%2020220309132129.webp)
...
- [Ridge Regression](./Ridge%2520Regression.md#)
...
- Loss function $$L : \mathbb{R}^k \times \mathbb{R}^k \rightarrow \mathbb{R}^{n \geq 0}$$
	- [Quadratic Loss](./Quadratic%2520Loss.md#)
