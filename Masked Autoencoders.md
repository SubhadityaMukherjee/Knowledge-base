...
- simple [Self Supervised](./Self%2520Supervised.md#)
- [ImageNet](./ImageNet.md#) and in [Transfer Learning](./Transfer%2520Learning.md#) that an [Auto Encoders](./Auto%2520Encoders.md#) —- a simple self-supervised method similar to techniques in NLP – provides scalable benefits
...
- But decomposing the image into patches (like [Vision Transformer](./Vision%2520Transformer.md#) reduces the quadratic computation cost of transformers compared to operating at the pixel level
