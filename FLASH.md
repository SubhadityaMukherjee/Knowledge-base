...
- FLASH
- performant layer (gated linear unit) and by combining it with an accelerator-efficient approximation strategy ([Mixed chunk attention](./Mixed%2520chunk%2520attention.md#))
- [GAU](./GAU.md#)
