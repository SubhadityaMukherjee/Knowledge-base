...
- Since the the task of finding closely-matching (CM) item pairs requires a pair of image+text inputs, they exploit this multi-[Modality](./Modality.md#) by employing [Modality Dropout](./Modality%2520Dropout.md#)
- text-only, image-only, and image-text mode
- However, RECON instead of [ITM Loss](./ITM%2520Loss.md#) offers better PR AUC
- Similarly, using the [ITM Loss](./ITM%2520Loss.md#) together with MLM and RECON does not change the performance
