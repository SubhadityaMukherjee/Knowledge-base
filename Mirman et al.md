...
- We aren't just sensitive to frequency: we are sensitive to actual [Transitional probabilities](./Transitional%2520probabilities.md#)
- SRNs with very simple assumptions model non-adjacent learning and [Transitional probabilities](./Transitional%2520probabilities.md#)
