...
- [Bootstrap Your Own Latent: a New Approach to Self-supervised Learning](https://arxiv.org/abs/2006.07733)
	- [[./Self Supervised|Self Supervised]] image representation learning
	...
	- From an augmented view of an image, they train the [[Online Learning|Online Learning]] network to predict the target network representation of the same image under a different augmented view
