...
- It is closely related to but is different from [KL Divergence](./KL%2520Divergence.md#) that calculates the relative [Entropy](./Entropy.md#) between two [Probability](./Probability.md#.md#) [Distributions](Distributions.md), whereas cross-[Entropy](./Entropy.md#) can be thought to calculate the total [Entropy](./Entropy.md#) between the [Distributions](Distributions.md).
...
$$
- [Binary Cross Entropy](./Binary%2520Cross%2520Entropy.md#)
...
- Also [Negative Log Likelihood](./Negative%2520Log%2520Likelihood.md#)
