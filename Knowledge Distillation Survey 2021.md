...
- [Low-rank factorization](./Low-rank%2520factorization.md#)
- [Transferred compact convolutional filters](./Transferred%2520compact%2520convolutional%2520filters.md#)
...
- Knowledge distillation has also been explored for [Label Smoothing](./Label%2520Smoothing.md#), for assessing the accuracy of the teacher and for obtaining a prior for the optimal output layer geometry (Tang et al., 2020).
...
- [Response Based Knowledge](./Response%2520Based%2520Knowledge.md#)
- [Feature Based Knowledge](./Feature%2520Based%2520Knowledge.md#)
