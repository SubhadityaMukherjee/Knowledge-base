...
- [Neural Radiance Field](./Neural%2520Radiance%2520Field.md#)
- Neural graphics primitives, parameterized by fully connected neural networks, can be costly to train and evaluate
- rely on task specific [Data Structures](./Data%2520Structures.md#)
...
- small neural network is augmented by a multiresolution hash table of trainable feature vectors whose values are optimized through [Gradient Descent](./Gradient%2520Descent.md#)
...
- parallelism
- fully-fused [Operator Fusion](./Operator%2520Fusion.md#) CUDA kernels with a focus on minimizing wasted bandwidth and compute operations
