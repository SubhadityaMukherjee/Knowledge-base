...
- It seems hard to exclude the possibility that the resulting stimulus might have content which causes the artificial neurons predicting the [Biological Neuron](./Biological%2520Neuron.md#) to fire more, but aren't causally necessary for the [Biological Neuron](./Biological%2520Neuron.md#) to fire.
