...
# [[./Attention|Attention]] Alignment
- If there are sequences $x, y$
	- Encoder is any [[./Recurrent|Recurrent]] with a forward state $$\overrightarrow h^{T}$$ and $$\overleftarrow h^{T}$$ for backward
...
- $v_{a}$ and $W_{a}$ are the learned [[./Attention|Attention]] params
- $h$ is the hidden state for the encoder
- $s$ is the hidden state for the decoder
- Matrix of alignment
	- ![[./images/Pasted image 20220621170423.webp|Pasted image 20220621170423.webp]]
	- Final scores calculated with a [[./Softmax|Softmax]]
