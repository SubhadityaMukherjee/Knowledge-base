...
- generalizing BERT (due to the bidirectional encoder), [[./GPT|GPT]] (with the left-to-right decoder),
...
- With [[./GPT|GPT]], tokens are predicted auto-regressively (generation of a new token is conditioned on the prior tokens), meaning [[./GPT|GPT]] can be used for generation.
...
- matches the performance of [[./RoBERTa|RoBERTa]] with comparable training resource
- [[./GLUE|GLUE]]
- [[./SQuAD|SQuAD]]
