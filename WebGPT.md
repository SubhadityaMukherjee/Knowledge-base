...
- fine-tuning [GPT](./GPT.md#)-3 using behavior cloning, and then performing [Rejection Sampling](./Rejection%2520Sampling.md#) against a reward model trained to predict human preferences
