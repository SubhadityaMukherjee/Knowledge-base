...
- If it is 0, and [Uniform Distribution](./Uniform%2520Distribution.md#) and limit to infinity -> binary vector which is 0 everywhere except at position i when y is maximal
