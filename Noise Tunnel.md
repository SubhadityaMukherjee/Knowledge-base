...
- Using SmoothGrad ([Noise Tunnel](Noise%2520Tunnel.md##figure-1)) seems to detect more edges of the input image (in comparison with pure IG attribution in \[Fig. 1b\]), and that can be interpreted as detecting decision boundary. SmoothGrad-Square ([Noise Tunnel](Noise%2520Tunnel.md##figure-1)) and VarGrad ([Noise Tunnel](Noise%2520Tunnel.md##figure-1)) are removing a large amount of noise but usually also some of the important features visible on the attribution from SmoothGrad
