...
- [Unsupervised Learning](./Unsupervised%2520Learning.md#)
- Discriminative [Self Supervised](./Self%2520Supervised.md#) learning allows training models on any random group of internet images, and possibly recover salient information that helps differentiate between the images
